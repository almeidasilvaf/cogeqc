...
Thanks for using `cogeqc`! Before filing an issue, there are a few
...
- If it’s a question: start with
  ...
  package tag](https://support.bioconductor.org/t/cogeqc) (the website
  will send an automatic email to the package authors). There are more
  people there to answer questions.

- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/almeidasilvaf/cogeqc/issues/new).
...
requests](https://github.com/almeidasilvaf/cogeqc/issues) to make sure
